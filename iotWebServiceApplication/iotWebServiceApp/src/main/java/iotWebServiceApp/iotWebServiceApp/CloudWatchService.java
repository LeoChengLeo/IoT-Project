...
/*
 *This Cloud Watch Service allow user to publish any custom metric to AWS cloud watch for  monitoring any variable. 
 *In this case, latest temperature data will be published to cloud watch, when webApp receive any post request of temperature sensorData  
 */
